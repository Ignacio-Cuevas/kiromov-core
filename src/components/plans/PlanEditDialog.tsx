...
import { Layers, Save, Tag, DollarSign, ListOrdered, CheckCircle2 } from "lucide-react";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
        ...
        <div className="flex items-center gap-2 text-slate-800">
          ...
          <div>
            ...
            <DialogDescription className="text-xs text-slate-500">
              {plan
                ? "Modifica los valores del catálogo maestro"
                : "Agrega una nueva tarifa disponible para la venta"}
            </DialogDescription>
          </div>
        </div>
      </DialogHeader>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 pt-2">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            placeholder="Ej: Convenio - Activa Care (4 Sesiones)"
            value={nombrePlan}
            ...
            <div className="flex items-center h-10">
              <label className="relative inline-flex items-center cursor-pointer gap-2">
                ...
                <span className="text-xs font-semibold text-slate-700">
                  {activo ? "Activo (En venta)" : "Inactivo (Oculto)"}
                </span>
              </label>
            </div>
          </div>
        ...
        <div className="space-y-1.5">
          ...
          <Textarea
            placeholder="Ej: Aplica para pacientes derivados de convenio o con orden médica..."
            value={descripcion}
