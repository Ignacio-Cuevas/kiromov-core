...
import { Layers, Save, Tag, DollarSign, ListOrdered, CheckCircle2, Loader2 } from "lucide-react";
    ...
    <Dialog open={open} onOpenChange={onOpenChange} maxWidth="max-w-xl">
      <DialogHeader onClose={() => onOpenChange(false)}>
        <div className="flex items-center gap-3">
          <div className="rounded-xl bg-clinic-50 p-2.5 text-clinic-600 border border-clinic-100 shrink-0">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
        <DialogBody className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <select
                ...
                disabled={isSaving}
                className="flex h-10 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 focus:border-clinic-500 focus:outline-none focus:ring-2 focus:ring-clinic-500/20 font-medium"
              >
          ...
          {totalSesiones > 0 && precioCLP > 0 && (
            <div className="rounded-xl bg-clinic-50/70 p-3 border border-clinic-200/60 flex items-center justify-between text-xs text-clinic-900">
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              disabled={isSaving}
              rows={2}
              className="text-sm bg-white rounded-xl resize-none"
            />
          </div>
        </DialogBody>
        ...
        <DialogFooter>
          ...
          <Button
            type="submit"
            disabled={isSaving}
            className="bg-clinic-600 hover:bg-clinic-700 text-white font-bold gap-2 text-xs h-9 px-5 shadow-xs rounded-xl"
          >
            {isSaving ? (
              <>
