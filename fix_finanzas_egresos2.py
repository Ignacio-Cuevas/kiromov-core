...
old_handler = """  const handleAddEgreso = async () => {
    if (!supabase) return;
...
old_modal_fields = """          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-slate-700">Categoría</label>"""
new_modal_fields = """          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="space-y-1.5">
